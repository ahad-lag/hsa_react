  ...
  return(
      <div className="flex justify-end bg-gray-50 shadow h-16 items-center px-4">
        ...
        <div className="flex items-center">
          ...
          <div className="pl-3">
            <svg onClick={() => setLogoutModal(true)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-rose-700 cursor-pointer">
              <path strokeLinecap="round" strokeLinejoin="round" d="M5.636 5.636a9 9 0 1012.728 0M12 3v9" />
            </svg>
          </div>
        </div>
        { logoutModal && <LogoutModal msg={`${userInfo.first_name} میخوای بری بیرون؟؟!؟`} setShowModal={setLogoutModal} showModal={logoutModal} logout={logout}/> }
      </div>
  )
}
